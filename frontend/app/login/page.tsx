    ...
    >
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>Sign in to access the dashboard</p>
        </div>
        ...
        >
          ...
          <CardContent>
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full mb-6 bg-white/5 hover:bg-white/10 text-white border border-white/10"
              variant="outline"
            >
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2" style={{ background: 'var(--card-bg)', color: 'var(--text-muted)' }}>or</span>
              </div>
            </div>

            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-white/5">
                <TabsTrigger value="login" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60">Sign In</TabsTrigger>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Mail className="absolute left-3 top-3 h-4 w-4" style={{ color: 'var(--text-muted)' }} />
                      <Input
                        id="login-email"
                        type="email"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4" style={{ color: 'var(--text-muted)' }} />
                      <Input
                        id="login-password"
